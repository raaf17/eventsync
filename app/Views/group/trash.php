...
<?= $this->section('title') ?>
<title>Data Trash &mdash; EventSync</title>
<?= $this->endSection() ?>
    ...
    <div class="card">
      ...
      <div class="card-header">
        ...
        <div class="card-header-action">
          ...
          <form action="<?= site_url('groups/delete2/'); ?>" method="post" class="d-inline" onsubmit="return confirm('Yakin mau hapus data?')">
            <?= csrf_field(); ?>
            ...
            <?php foreach ($group_data as $key => $value) : ?>
              <tr>
                ...
                <td class="text-center" style="width: 15%;">
                  ...
                  <form action="<?= site_url('groups/delete2/' . $value->id_group); ?>" method="post" class="d-inline" onsubmit="return confirm('Yakin mau hapus data?')">
                    <?= csrf_field(); ?>
