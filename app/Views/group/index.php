...
<?= $this->section('title') ?>
<title>Data Groups &mdash; EventSync</title>
<?= $this->endSection() ?>
              ...
              <tr>
                ...
                <td class="text-center" style="width: 15%;">
                  ...
                  <form action="<?= site_url('groups/delete/' . $value->id_group); ?>" method="post" class="d-inline" id="del-<?= $value->id_group; ?>">
                    <?= csrf_field(); ?>
                    <button href="submit" class="btn btn-danger btn-sm" data-confirm="Hapus Data?|Apakah Anda Yakin?" data-confirm-yes="submitDel(<?= $value->id_group; ?>)"><i class="fas fa-trash"></i></button>
                  </form>
                </td>
              </tr>
            <?php endforeach; ?>
